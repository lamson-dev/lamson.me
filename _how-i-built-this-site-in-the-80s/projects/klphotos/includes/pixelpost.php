...
Copyright 2012 Pixelpost.org <http://www.pixelpost.org>
...
$pixelpost_db_user      = "lamson5_test";  // database user
$pixelpost_db_pass      = "testing";  // database user password
$pixelpost_db_pixelpost = "lamson5_test";  // database
