...
if (isset($_GET['pagenum'])&&$_GET['pagenum'] != "")
{
	...
	$archive_select = "<select name='browse' onchange='self.location.href=this.options[this.selectedIndex].value;'><option value=''>Monatliches Archiv</option><option value='index.php?x=browse&amp;pagenum=1'>$lang_browse_all (" .$pixelpost_all_photonumb .")</option>";
...
else
{
	...
	if (isset($thedate))
	{
		$archive_select = "<select name='browse' onchange='self.location.href=this.options[this.selectedIndex].value;'><option value=''>Monatliches Archiv</option><option value='index.php?x=browse&amp;archivedate=$thedate&amp;pagenum=1'>$lang_browse_all (" .$pixelpost_all_photonumb .")</option>";
